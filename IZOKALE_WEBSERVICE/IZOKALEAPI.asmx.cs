            ...
            using (SqlConnection con = new SqlConnection(IzoKaleConnectionString))
            {
                ...
                cmdMalzemeler.CommandText =
                                    ...
                                    "BEGIN " +
                                            ...
                                            "  ISNULL((SELECT UTM.CONVFACT2 FROM LG_" + IzoKaleFirmaNo + "_UNITSETL UNT LEFT JOIN LG_" + IzoKaleFirmaNo + "_ITMUNITA UTM ON UNT.LOGICALREF=UTM.UNITLINEREF  WHERE UNT.CODE='PALET' AND UTM.ITEMREF=ITEM.LOGICALREF),1) PALET_KT" +
